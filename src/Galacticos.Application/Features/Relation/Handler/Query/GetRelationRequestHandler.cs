...
{
    public class GetRelationRequestHandler : IRequestHandler<GetRelationRequest, RelationDTO>
    {
        ...
        public async Task<RelationDTO> Handle(GetRelationRequest request, CancellationToken cancellationToken)
        {
